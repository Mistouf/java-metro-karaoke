...
// Les timestamps des stations sont RELATIFS au startTime de la ligne
export const metroLyrics: LyricLine[] = [
  ...
  {
    "text": "Laisse-toi Bercy par le rythme saccadé",
    "startTime": 79.16,
    "stations": [
      {
        "name": "Bercy",
  ...
  {
    "text": "Au Saint-Sulpice c'est un Crimée Sentier",
    "startTime": 127.88,
    "stations": [
      {
        "name": "Saint-Sulpice",
  ...
  {
    "text": "oui on sait c'que tu Vaugirard-ment vu Pyrénées-rgumène",
    "startTime": 130.88,
    "stations": [
      {
        "name": "Vaugirard",
